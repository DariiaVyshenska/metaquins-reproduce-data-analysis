...
plot_stackbar(plot_df = input_table, file_name = "normalized_bars/log_lm.pdf")

# TO DO non-log lm scaling
...
plot_stackbar(plot_df = input_table, file_name = "normalized_bars/ratio.pdf")


# calculate RPKM for scaffolds and sequins
# transform calculations into fractions
# sum up fraction spike-ins per sample (for equal-amount sequins)
# devide scaffold fractions by spikin fractions (for each sample)
